    ...
    <div class="row">
      ...
      <div class="row">
        <div class="col-md-7 align-middle">
          ...
          <ul>
            <li>Colaborar con el Director Ejecutivo, el/la/elle Asistente de Administración y e/la/elle Coordinador Estatal Subcontratadx para dirigir 20 entrenamientos de navegadores en todo el estado, al menos 14 de los cuales están fuera del metro PDX.</li>
            <li>Colaborar con el Director Ejecutivo, el/la/elle Asistente de Administración y e/la/elle Coordinador Estatal Subcontratadxo para ofrecer 30 eventos de alcance lingüísticamente específicos a miembros de la comunidad de inmigrantes en todo el estado, al menos 20 de los cuales están fuera del área metropolitana de PDX.</li>
            <li>Colaborar con el Director Ejecutivo, e/la/elle Coordinador Estatal Subcontratado y lxs navegadores voluntarixs capacitadxs para enviar al menos 200 navegaciones de solicitantes elegibles para el programa, de las cuales al menos 125 residen fuera del área metropolitana de PDX.</li>
            <li>Colaborar con e/la/elle coordinador estatal subcontratadx para coordinar y administrar navegadores voluntarixs capacitadxs.</li>
            <li>Involucrar a los clientes mediante los enfoques basados en fortalezas e informados sobre el trauma.</li>
            ...
            <li>La entrada de datos oportuna y completa en las bases de datos requeridas.
Otros deberes y responsabilidades asignados.</li>
