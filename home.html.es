      ...
      <div class="col-md-12 align-middle">
        <div class="video">
          <div class="video__media">
            <iframe 
              title="YouTube Video About Pueblo Unido" 
              width="100%" 
              height="473" 
              src="https://www.youtube.com/embed/5zcidvf2rbY" 
              frameborder="0" 
              allow="autoplay; 
              encrypted-media" 
              allowfullscreen 
    ...
    <div class="row">
      ...
      <div class="col-md-5 align-middle">
        <div class="heading__image">
          <img loading="lazy" alt="Foto de Equipo" src="./assets/images/pu-images/png/team--july.jpg" />
        </div>
      </div>
    </div>
  </div>
