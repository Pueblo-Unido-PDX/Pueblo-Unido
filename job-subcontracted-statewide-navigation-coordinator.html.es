    ...
    <div class="row">
      <div class="col-md-12">
        <div class="introduction__text">
          <h1>Oferta de Empleo: Coordinador de Navegación Estatal Subcontratado</h1>
        </div>
        <div class="introduction__link">
          <a class="button" href="job-subcontracted-statewide-navigation-coordinator.html.en">Read in English</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-md-7 align-middle">
        <div class="heading__subheadline">
          <h2>Oferta de Empleo: Coordinador de Navegación Estatal Subcontratado</h2>
          <div class="horizontal-line"></div>
        </div>
        <br />
        <div class="heading__text">
          <p>Pueblo Unido seeks to subcontract with an organization outside the Portland metro area to engage with the services of a full time Statewide Navigation Coordinator. The subcontracted Statewide Navigation Coordinator will conduct outreach presentations and navigator trainings, coordinate a network of trained volunteer navigators, and deliver Equity Corps navigations. The subcontracted Coordinator will collaborate with the Coordinator, Admin Assistant, and Executive Director at Pueblo Unido to provide reliable access to Equity Corps across the state. In Year 1, the Coordinator’s focus will be to travel outside the Portland metro region to recruit navigators and deliver trainings. In Year 2, the Coordinator’s focus will be to deliver outreach presentations, submit navigations, and manage trained volunteer navigators. The Coordinator will be responsible for tracking and reporting service outcomes.</p>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-7 align-middle">
          ...
          <ul>
            ...
            <li>Collaborate with Executive Director, Admin Assistant, and Statewide Coordinator at Pueblo Unido to lead 20 navigator trainings around the state, at least 14 of which are outside PDX metro.</li>
            <li>Collaborate with Executive Director, Admin Assistant, and Statewide Coordinator at Pueblo Unido to deliver 30 linguistically-specific outreach events to immigrant community members around the state, at least 20 of which are outside PDX metro.</li>
            <li>Collaborate with Executive Director, Statewide Coordinator at Pueblo Unido, and trained volunteer navigators to submit at least 200 navigations of program-eligible applicants, at least 125 of which reside outside the PDX metro area.</li>
            <li>Collaborate with Statewide Coordinator at Pueblo Unido to coordinate and manage trained volunteer navigators.</li>
          ...
          <ul>
            ...
            <li>Experience and knowledge working with a broad range of issues affecting Latinxs/Communities of Color in the community especially resources related to immigration status.</li>
            ...
            <li>Ability to travel long distances throughout the state of Oregon.</li>
            <li>Ability to support organizational and program specific mission and goals.
Ability to lift 40 pounds.</li>
            <li>Must have a driver's license, ability to obtain automobile insurance at levels required by agency (100/300/100), and own a reliable vehicle. Frequent travel throughout Oregon required.</li>
            <li>Satisfactory results from civil, criminal and motor vehicle background check required.</li>
          </ul>
          <p>&nbsp;</p>
          <h3>Compensation</h3>
